...
public:
    ...
    ListNodePosi<T> find(T const& e, int n, ListNodePosi p)const;//无序区间查找
    ListNodePosi<T> search(T const& e, int n, ListNodePosi p)const;//有序区间查找
    ...
    oid sort() { sort ( first(), _size ); } //列表整体排序
